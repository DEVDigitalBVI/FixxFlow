...
type TicketCategory = { default_team_id: string | null; id: string; organization_id: string; name: string; is_active: boolean; created_at: string; updated_at: string };
