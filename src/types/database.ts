...
type Profile = { organization_id: string; user_id: string; department_id: string | null; location_id: string | null; display_name: string; job_title: string | null; phone: string | null; avatar_path: string | null; created_at: string; updated_at: string };
