...
export const auditEntities: Record<string,string> = {tickets:'Tickets',organization_memberships:'Member access',organizations:'Organization',profiles:'Profiles',departments:'Departments',locations:'Locations',teams:'Teams',ticket_categories:'Categories',ticket_subcategories:'Subcategories',knowledge_articles:'Knowledge articles',chat_conversations:'Chats',ticket_messages:'Replies & notes'};
export const auditFields: Record<string,string> = {title:'Title',description:'Description',status:'Status',priority:'Priority',requester_id:'Requester',assigned_technician_id:'Assigned to',team_id:'Team',category_id:'Category',subcategory_id:'Subcategory',location_id:'Location',department_id:'Department',due_at:'Due date',role:'Role',name:'Name',slug:'Workspace address',logo_path:'Logo',display_name:'Display name',is_active:'Available',timezone:'Timezone',category:'Category',content:'Article content',related_article_ids:'Related articles',ticket_id:'Linked ticket',kind:'Visibility',body:'Message content'};
